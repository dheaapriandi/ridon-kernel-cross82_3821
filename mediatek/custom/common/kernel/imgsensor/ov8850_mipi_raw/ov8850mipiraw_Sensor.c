...
kal_bool OV8850MIPIDuringTestPattern = KAL_FALSE;
...
static void OV8850_global_setting(void)
{
	...
	***************************************************/
    ...
    OV8850_write_cmos_sensor(0x3820, 0x53);
    OV8850_write_cmos_sensor(0x3821, 0x09);
...
UINT32 OV8850Open(void)
{
   ...
   OV8850MIPIDuringTestPattern = KAL_FALSE;
   spin_unlock(&OV8850_drv_lock);
...
#endif
        if(OV8850MIPI_SENSOR_ID == sensor_id)
        {
...
UINT32 OV8850GetSensorID(UINT32 *sensorID) 
{
 ...
 SENSORDB("OV8850GetSensorID enter,\n");
...
#endif
        if(OV8850MIPI_SENSOR_ID == *sensorID)
        {
            SENSORDB("OV8850 slave write id:%x \n",OV8850_sensor.write_id);
            break;
        }
    ...
    // check if sensor ID correct		
    if (*sensorID != OV8850MIPI_SENSOR_ID) 
    {
        	SENSORDB("[Warning]OV8850GetSensorID, sensor_id:%x \n",*sensorID);
			*sensorID = 0xFFFFFFFF;
			return ERROR_SENSOR_CONNECT_FAIL;
        ...
        MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    if(OV8850MIPIDuringTestPattern)
        OV8850_write_cmos_sensor(0x5E00, 0x80);
...
UINT32 OV8850MIPI_SetTestPatternMode(kal_bool bEnable)
{
    kal_uint16 temp;
    ...
    {
        spin_lock(&OV8850_drv_lock);
        OV8850MIPIDuringTestPattern = KAL_TRUE;
        spin_unlock(&OV8850_drv_lock);
        
//	    temp = 0x7F & OV8850_read_cmos_sensor(0x5000);
//	    OV8850_write_cmos_sensor(0x5000, temp);
...
#define OV8850MIPI_TEST_PATTERN_CHECKSUM (0xdd3cdc93)
        ...
        UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
    ...
    switch (FeatureId)
    {
        ...
        case SENSOR_FEATURE_GET_REGISTER_DEFAULT:
            ...
            ((PNVRAM_SENSOR_DATA_STRUCT)pFeaturePara)->SensorId = OV8850MIPI_SENSOR_ID;
        ...
        case SENSOR_FEATURE_SET_TEST_PATTERN:
            OV8850MIPI_SetTestPatternMode((BOOL)*pFeatureData16);
            break;
        case SENSOR_FEATURE_GET_TEST_PATTERN_CHECKSUM_VALUE://for factory mode auto testing             
            *pFeatureReturnPara32= OV8850MIPI_TEST_PATTERN_CHECKSUM;
            *pFeatureParaLen=4;                             
            break;
        default:
            break;
