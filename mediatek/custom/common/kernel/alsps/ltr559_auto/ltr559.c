...
static int ltr559_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	if((err = ltr559_create_attr(&(LTR559_init_info.platform_diver_addr->driver)))<0)
	{
...
{
	int err;	
	if((err = ltr559_delete_attr(&(LTR559_init_info.platform_diver_addr->driver))) < 0)
	{
