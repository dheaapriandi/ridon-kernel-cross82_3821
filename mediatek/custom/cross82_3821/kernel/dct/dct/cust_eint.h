...
#define CUST_EINT_TOUCH_PANEL_NUM              18
...
#define CUST_EINT_PROCTION_NUM              54
#define CUST_EINT_PROCTION_DEBOUNCE_CN      10
#define CUST_EINT_PROCTION_TYPE							CUST_EINTF_TRIGGER_LOW
#define CUST_EINT_PROCTION_DEBOUNCE_EN      CUST_EINT_DEBOUNCE_ENABLE
