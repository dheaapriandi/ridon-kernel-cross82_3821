...
void boot_mode_menu_select()
{
	...
	while(mtk_detect_key(MT65XX_RECOVERY_KEY)||mtk_detect_key(MT65XX_FACTORY_KEY))//VOL_UP
	{
	...
	while(1)
	{
		...
		else if(mtk_detect_key(MT65XX_FACTORY_KEY))//VOL_DOWN,
		{
			select=1;
			break;
		}
